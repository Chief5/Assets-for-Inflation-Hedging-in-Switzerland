...
def calculate_correlation(portfolio):
    ...
    correlation_values = []
    # Calculate single correlation for MoM (Month-over-Month) data
    ...
    # Calculate single correlation for YoY (Year-over-Year) data
...
def calculate_correlations_for_all_portfolios(all_portfolios):
...
def plot_combined_correlation_table(correlations_dict):
    ...
    for i, (interval, mom_df) in enumerate(mom_data):
        ...
        ax_mom.set_title("MoM Correlations")
        ...
        ax_yoy.table(cellText=yoy_df.values,
                     ...
                     cellLoc='center', loc='center')
        ax_yoy.set_title("YoY Correlations")
...
all_correlations = calculate_correlations_for_all_portfolios(all_portfolios)

print("lenght of all portfolion" ,len(all_correlations))
print("lenght of all portfolion" ,type(all_correlations))

# Generate plots for the intervals
plot_combined_correlation_table(all_correlations)