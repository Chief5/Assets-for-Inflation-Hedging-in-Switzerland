...
# display_table_with_colorscale(mom_table_max, "Real Returns : Maximum MoM Correlation Table")
# display_table_with_colorscale(yoy_table_max, "Real Returns : Maximum YoY Correlation Table")
# display_table_with_colorscale(mom_table_min, "Real Returns : Minimum MoM Correlation Table")
# display_table_with_colorscale(yoy_table_min, "Real Returns : Minimum YoY Correlation Table")
...
with PdfPages("Results/2_Presentation_Real_Returns_Tables.pdf") as pdf:
