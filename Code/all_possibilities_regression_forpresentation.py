...
# Add a title
    ...
    # Save figure
    # plt.savefig("cumulative_optimal_expo_hedge.pdf", dpi= 300, bbox_inches = 'tight')
...
# display_table_with_colorscale(mom_table_max, "Complete Regression: Maximum MoM Correlation Table",save_path="Regression Results.pdf")
# display_table_with_colorscale(yoy_table_max, "Complete Regression: Maximum YoY Correlation Table",save_path="Regression Results.pdf")
# display_table_with_colorscale(mom_table_min, "Complete Regression: Minimum MoM Correlation Table",save_path="Regression Results.pdf")
# display_table_with_colorscale(yoy_table_min, "Complete Regression: Minimum YoY Correlation Table",save_path="Regression Results.pdf")
